...
var PROJECTS = [{
  ...
  properties: ['сементическая размеска', 'адаптив', 'кроссбраузерность', 'анимация'],
  ...
  tools: ['JavaScript', 'HTML', 'CSS'],
  properties: ['fetch', 'paginashion'],
  linkSite: 'projects/Table/index.html',
  linkCode: 'https://github.com/ChernovaNV/3a.Table',
  descs: [{
    subtitle: 'Особенности проекта:',
    desc: 'Таблица на JаvaScript с дополнительными возможностями для пользователя.'
  }, {
    subtitle: 'Функционал:',
    listComplite: ['данные для таблицы получены с помощью fetch-запроса;', 'реализована клиентская пагинация с навигацией по страницам;', 'реализована сортировка данных по столбцам по возрастанию (при повторном клике - по убыванию);']
  }]
}, {
  name: 'Журнал (Fashion)',
